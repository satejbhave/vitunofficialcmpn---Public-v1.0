  ...
  table{
    ...
    <table align="right" border="0" style="width: 100%; text-align: center ;">
        <tr>
            ...
            <td onclick="sendToProgramming()" style="width: 16.6%; height: 30;color: white ; font-weight: normal; font-size: 20; font-family: Arial, Helvetica, sans-serif; background-image: linear-gradient(#00f , #009);    border-top-left-radius: 20px;
                border-top-right-radius: 20px;
               border-bottom-left-radius: 20px;
               border-bottom-right-radius: 20px;">
                Programming
    ...
    <br>
        ...
        <table align="center" border="2" style="margin-top: 60px;" >
            <tr style="color:white;" >
              <th style="padding-top: 5px; padding-bottom: 5px; padding-left:20px ; padding-right:20px"> <a href="#programing_notes" style="color:white;">Programming Notes Section</a></th>
              <th  style="padding-top: 5px; padding-bottom: 5px; padding-left:20px ; padding-right:20px"> <a href="#programing_rec" style="color:white;">Programming Video Section</a></th>
            </tr>
        </table>

        <div id="programing_notes">
        <br>
        <table align="center"  border="1"  style=" background: black ; margin-top: 50 ;">

            <tr>
                <th colspan="4" style="color: white; padding-top: 5; padding-bottom: 5; font-family:cursive; font-size: 20;">Programming Notes</th>
            </tr>
